...
<body class="bg-gray-100 text-[#000b58] flex">
        ...
        <div class="p-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="flex justify-between items-center mb-4">
                    <h2 class="text-xl font-semibold">Daftar Konfirmasi Tiket</h2>
                </div>
                            ...
                            while($ticket = $result->fetch_assoc()) {
                                ...
                                <td class='p-3 text-center'>
                                    <div class='flex justify-center space-x-2'>
                                        <button onclick=\"openValidateModal('{$ticket['purchase_id']}', '{$ticket['name']}', '{$ticket['kode_ticket']}')\"
    ...
    <!-- Modal Confirm -->
    <div id="validateModal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 flex items-center justify-center">
        <div class="bg-white p-8 rounded-lg w-96 text-center">
            <div class="mb-4">
                <i class="fa-solid fa-check text-green-500 mx-auto w-10 h-10"></i>
                <h2 class="text-xl font-semibold mb-2">Lauching Ticket</h2>
                <p class="text-gray-600 mb-6">
                    Anda yakin ingin menerbitkan tiket untuk <span id="namaUser"></span> ?
                </p>
            </div>
            <div class="flex justify-center space-x-4">
                <button onclick="closeModal('validateModal')" class="bg-gray-200 text-gray-700 px-4 py-2 rounded">
                    Batal
                </button>
                <button id="confirmValidate" class="bg-green-500 text-white px-4 py-2 rounded">
                    Yakin
                </button>
            </div>
        </div>
